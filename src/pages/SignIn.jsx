                    ...
                    <form className="space-y-6">
                        <div>
                            ...
                            <input
                                type="email"
                                id="email"
                                className="w-full px-4 py-3 border border-gray-300 rounded-lg text-gray-800 placeholder-gray-400 dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-300"
                        ...
                        <motion.button
                            ...
                            whileTap={{ scale: 0.98 }}
                            type="submit"
                            className="w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 px-4 rounded-lg shadow-md hover:shadow-lg transition duration-300 dark:bg-blue-700 dark:hover:bg-blue-800"
                        >
                            Sign in
                        </motion.button>
                      ...
                      <div className="divider text-gray-400">Or continue with</div>
                        ...
                        <button className="btn mt-6 bg-white text-black border-[#e5e5e5] w-full">
